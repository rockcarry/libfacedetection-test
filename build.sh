...
"")
    ...
    cmake ../ -DCMAKE_INSTALL_PREFIX=$TOPDIR/libfacedetection/install -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF -DENABLE_AVX2=OFF -DENABLE_AVX512=OFF -DDEMO=OFF
    make -j8 && make install
    cd $TOPDIR
    g++ -I$TOPDIR/libfacedetection/install/include/facedetection \
        -L$TOPDIR/libfacedetection/install/lib \
        -Wall bmpfile.c test.c -lfacedetection -fopenmp -o test
    ;;
clean)
